 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'IsDisForRial.');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'ssh://git@source.int.netcentric.biz:7999/~dragan.filipovic/bagdes-react-redux-jira.git');
 ...
 */
define('TARGET_DIR', '/var/www/html/app/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/var/www/html/app/tmpgit/spgd-'.md5(REMOTE_REPOSITORY).'/');
